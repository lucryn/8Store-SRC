...
namespace Newtonsoft.Json.Utilities
{
	...
	{
		// Token: 0x0600050A RID: 1290 RVA: 0x00014738 File Offset: 0x00012938
		...
		})] StructMultiKey<Type, NamingStrategy> key)
		{
			...
			for (int i = 0; i < names.Length; i++)
			{
				...
				string text2 = Enumerable.SingleOrDefault<string>(Enumerable.Select<EnumMemberAttribute, string>(Enumerable.Cast<EnumMemberAttribute>(CustomAttributeExtensions.GetCustomAttributes(field, typeof(EnumMemberAttribute), true)), (EnumMemberAttribute a) => a.Value));
		...
		// Token: 0x0600050B RID: 1291 RVA: 0x00014854 File Offset: 0x00012A54
		[NullableContext(0)]
		...
		// Token: 0x0600050C RID: 1292 RVA: 0x00014956 File Offset: 0x00012B56
		...
		// Token: 0x0600050D RID: 1293 RVA: 0x0001496C File Offset: 0x00012B6C
		...
		// Token: 0x0600050E RID: 1294 RVA: 0x000149CC File Offset: 0x00012BCC
		[return: Nullable(2)]
		...
		// Token: 0x0600050F RID: 1295 RVA: 0x00014A6A File Offset: 0x00012C6A
		...
		// Token: 0x06000510 RID: 1296 RVA: 0x00014A80 File Offset: 0x00012C80
		...
		// Token: 0x06000511 RID: 1297 RVA: 0x00014B50 File Offset: 0x00012D50
		public static object ParseEnum(Type enumType, [Nullable(2)] NamingStrategy namingStrategy, string value, bool disallowNumber)
		{
			...
			while (j <= value.Length)
			{
				...
				num = EnumUtils.MatchName(value, names, resolvedNames, j, valueSubstringLength, 4);
				if (num == null)
				{
					num = EnumUtils.MatchName(value, names, resolvedNames, j, valueSubstringLength, 5);
				}
				if (num == null)
				{
		...
		// Token: 0x06000512 RID: 1298 RVA: 0x00014DA4 File Offset: 0x00012FA4
		...
		// Token: 0x06000513 RID: 1299 RVA: 0x00014DD8 File Offset: 0x00012FD8
