...
namespace Newtonsoft.Json
{
	...
	{
		// Token: 0x06000027 RID: 39 RVA: 0x000021E7 File Offset: 0x000003E7
		...
		// Token: 0x06000029 RID: 41 RVA: 0x000022B8 File Offset: 0x000004B8
		public string Add(string key)
		{
			...
			{
				if (entry.HashCode == num && entry.Value.Equals(key, 4))
				{
					return entry.Value;
				}
			}
		...
		// Token: 0x0600002A RID: 42 RVA: 0x00002364 File Offset: 0x00000564
		...
		private class Entry
		{
			// Token: 0x06000D65 RID: 3429 RVA: 0x00034885 File Offset: 0x00032A85
