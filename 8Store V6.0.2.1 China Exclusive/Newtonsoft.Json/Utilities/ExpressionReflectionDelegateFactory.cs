...
namespace Newtonsoft.Json.Utilities
{
	...
	internal class ExpressionReflectionDelegateFactory : ReflectionDelegateFactory
	{
		...
		// (get) Token: 0x06000515 RID: 1301 RVA: 0x00014E40 File Offset: 0x00013040
		...
		// Token: 0x06000516 RID: 1302 RVA: 0x00014E48 File Offset: 0x00013048
		...
		public override ObjectConstructor<object> CreateParameterizedConstructor(MethodBase method)
		{
			...
			return (ObjectConstructor<object>)Expression.Lambda(typeof(ObjectConstructor<object>), expression, new ParameterExpression[]
			{
				parameterExpression
			}).Compile();
		}

		// Token: 0x06000517 RID: 1303 RVA: 0x00014EB0 File Offset: 0x000130B0
		[RequiresDynamicCode("Newtonsoft.Json relies on dynamically creating types that may not be available with Ahead of Time compilation.")]
		...
		public override MethodCall<T, object> CreateMethodCall<[Nullable(2)] T>(MethodBase method)
		{
			...
			return (MethodCall<T, object>)Expression.Lambda(typeof(MethodCall<T, object>), expression, new ParameterExpression[]
			{
				parameterExpression,
		...
		// Token: 0x06000518 RID: 1304 RVA: 0x00014F28 File Offset: 0x00013128
		...
		// Token: 0x06000519 RID: 1305 RVA: 0x00015118 File Offset: 0x00013318
		[RequiresDynamicCode("Newtonsoft.Json relies on dynamically creating types that may not be available with Ahead of Time compilation.")]
		...
		// Token: 0x0600051A RID: 1306 RVA: 0x000151C4 File Offset: 0x000133C4
		[RequiresDynamicCode("Newtonsoft.Json relies on dynamically creating types that may not be available with Ahead of Time compilation.")]
		[return: Nullable(new byte[]
		{
			1,
		...
		// Token: 0x0600051B RID: 1307 RVA: 0x00015268 File Offset: 0x00013468
		[RequiresDynamicCode("Newtonsoft.Json relies on dynamically creating types that may not be available with Ahead of Time compilation.")]
		[return: Nullable(new byte[]
		{
			1,
		...
		// Token: 0x0600051C RID: 1308 RVA: 0x000152E4 File Offset: 0x000134E4
		[RequiresDynamicCode("Newtonsoft.Json relies on dynamically creating types that may not be available with Ahead of Time compilation.")]
		[return: Nullable(new byte[]
		{
			1,
		...
		public override Action<T, object> CreateSet<[Nullable(2)] T>(FieldInfo fieldInfo)
		{
			...
			return (Action<T, object>)Expression.Lambda(typeof(Action<T, object>), binaryExpression, new ParameterExpression[]
			{
				parameterExpression,
				parameterExpression2
			}).Compile();
		...
		// Token: 0x0600051D RID: 1309 RVA: 0x000153B0 File Offset: 0x000135B0
		[RequiresDynamicCode("Newtonsoft.Json relies on dynamically creating types that may not be available with Ahead of Time compilation.")]
		[return: Nullable(new byte[]
		{
			1,
		...
		public override Action<T, object> CreateSet<[Nullable(2)] T>(PropertyInfo propertyInfo)
		{
			...
			{
				expression2 = Expression.Call(this.EnsureCastExpression(parameterExpression, propertyInfo.DeclaringType, false), setMethod, new Expression[]
				{
					expression
				});
			}
			return (Action<T, object>)Expression.Lambda(typeof(Action<T, object>), expression2, new ParameterExpression[]
			{
				parameterExpression,
				parameterExpression2
			}).Compile();
		...
		// Token: 0x0600051E RID: 1310 RVA: 0x00015494 File Offset: 0x00013694
		...
		{
			// Token: 0x06000E4D RID: 3661 RVA: 0x0003F35F File Offset: 0x0003D55F
