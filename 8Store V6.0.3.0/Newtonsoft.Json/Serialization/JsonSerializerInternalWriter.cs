...
namespace Newtonsoft.Json.Serialization
{
	...
	{
		// Token: 0x06000797 RID: 1943 RVA: 0x0002092F File Offset: 0x0001EB2F
		public JsonSerializerInternalWriter(JsonSerializer serializer) : base(serializer)
		{
		}

		// Token: 0x06000798 RID: 1944 RVA: 0x00020944 File Offset: 0x0001EB44
		[NullableContext(2)]
		...
		// Token: 0x06000799 RID: 1945 RVA: 0x000209F4 File Offset: 0x0001EBF4
		[RequiresUnreferencedCode("Newtonsoft.Json relies on reflection over types that may be removed when trimming.")]
		[RequiresDynamicCode("Newtonsoft.Json relies on dynamically creating types that may not be available with Ahead of Time compilation.")]
		...
		// Token: 0x0600079A RID: 1946 RVA: 0x00020A10 File Offset: 0x0001EC10
		[NullableContext(2)]
		...
		// Token: 0x0600079B RID: 1947 RVA: 0x00020A1E File Offset: 0x0001EC1E
		private JsonContract GetContract(object value)
		{
			return this.Serializer._contractResolver.ResolveContract(value.GetType());
		}

		// Token: 0x0600079C RID: 1948 RVA: 0x00020A38 File Offset: 0x0001EC38
		...
		// Token: 0x0600079D RID: 1949 RVA: 0x00020AA0 File Offset: 0x0001ECA0
		[NullableContext(2)]
		[RequiresUnreferencedCode("Newtonsoft.Json relies on reflection over types that may be removed when trimming.")]
		[RequiresDynamicCode("Newtonsoft.Json relies on dynamically creating types that may not be available with Ahead of Time compilation.")]
		...
		// Token: 0x0600079E RID: 1950 RVA: 0x00020C38 File Offset: 0x0001EE38
		[NullableContext(2)]
		...
		// Token: 0x0600079F RID: 1951 RVA: 0x00020C90 File Offset: 0x0001EE90
		[NullableContext(2)]
		...
		// Token: 0x060007A0 RID: 1952 RVA: 0x00020D28 File Offset: 0x0001EF28
		[NullableContext(2)]
		...
		// Token: 0x060007A1 RID: 1953 RVA: 0x00020D78 File Offset: 0x0001EF78
		[NullableContext(2)]
		...
		// Token: 0x060007A2 RID: 1954 RVA: 0x00020F08 File Offset: 0x0001F108
		...
		// Token: 0x060007A3 RID: 1955 RVA: 0x00020F84 File Offset: 0x0001F184
		...
		// Token: 0x060007A4 RID: 1956 RVA: 0x00020FDC File Offset: 0x0001F1DC
		[RequiresUnreferencedCode("Newtonsoft.Json relies on reflection over types that may be removed when trimming.")]
		...
		// Token: 0x060007A5 RID: 1957 RVA: 0x00021038 File Offset: 0x0001F238
		[RequiresUnreferencedCode("Newtonsoft.Json relies on reflection over types that may be removed when trimming.")]
		...
		// Token: 0x060007A6 RID: 1958 RVA: 0x00021070 File Offset: 0x0001F270
		...
		// Token: 0x060007A7 RID: 1959 RVA: 0x000210D4 File Offset: 0x0001F2D4
		...
		// Token: 0x060007A8 RID: 1960 RVA: 0x00021138 File Offset: 0x0001F338
		[RequiresUnreferencedCode("Newtonsoft.Json relies on reflection over types that may be removed when trimming.")]
		[RequiresDynamicCode("Newtonsoft.Json relies on dynamically creating types that may not be available with Ahead of Time compilation.")]
		...
		// Token: 0x060007A9 RID: 1961 RVA: 0x00021324 File Offset: 0x0001F524
			...
			if (!property.Ignored && property.Readable && this.ShouldSerialize(writer, property, value) && this.IsSpecified(writer, property, value))
			{
				...
				if (this.ShouldWriteProperty(memberValue, contract as JsonObjectContract, property))
				{
					...
					if (memberValue == null)
					{
						...
						Required required = property._required ?? ((jsonObjectContract != null) ? jsonObjectContract.ItemRequired : default(Required?)).GetValueOrDefault();
		...
		// Token: 0x060007AA RID: 1962 RVA: 0x000214B4 File Offset: 0x0001F6B4
		...
		// Token: 0x060007AB RID: 1963 RVA: 0x00021540 File Offset: 0x0001F740
		...
		// Token: 0x060007AC RID: 1964 RVA: 0x0002156C File Offset: 0x0001F76C
		...
		// Token: 0x060007AD RID: 1965 RVA: 0x000215D8 File Offset: 0x0001F7D8
		...
		// Token: 0x060007AE RID: 1966 RVA: 0x00021655 File Offset: 0x0001F855
		private bool HasFlag(DefaultValueHandling value, DefaultValueHandling flag)
		{
			return (value & flag) == flag;
		}

		// Token: 0x060007AF RID: 1967 RVA: 0x0002165D File Offset: 0x0001F85D
		private bool HasFlag(PreserveReferencesHandling value, PreserveReferencesHandling flag)
		{
			return (value & flag) == flag;
		}

		// Token: 0x060007B0 RID: 1968 RVA: 0x00021665 File Offset: 0x0001F865
		private bool HasFlag(TypeNameHandling value, TypeNameHandling flag)
		{
			return (value & flag) == flag;
		}

		// Token: 0x060007B1 RID: 1969 RVA: 0x00021670 File Offset: 0x0001F870
		[RequiresUnreferencedCode("Newtonsoft.Json relies on reflection over types that may be removed when trimming.")]
		[RequiresDynamicCode("Newtonsoft.Json relies on dynamically creating types that may not be available with Ahead of Time compilation.")]
		...
		// Token: 0x060007B2 RID: 1970 RVA: 0x00021770 File Offset: 0x0001F970
		[RequiresUnreferencedCode("Newtonsoft.Json relies on reflection over types that may be removed when trimming.")]
		[RequiresDynamicCode("Newtonsoft.Json relies on dynamically creating types that may not be available with Ahead of Time compilation.")]
		...
		// Token: 0x060007B3 RID: 1971 RVA: 0x000218DC File Offset: 0x0001FADC
		[RequiresUnreferencedCode("Newtonsoft.Json relies on reflection over types that may be removed when trimming.")]
		[RequiresDynamicCode("Newtonsoft.Json relies on dynamically creating types that may not be available with Ahead of Time compilation.")]
		...
		// Token: 0x060007B4 RID: 1972 RVA: 0x0002194C File Offset: 0x0001FB4C
		[RequiresUnreferencedCode("Newtonsoft.Json relies on reflection over types that may be removed when trimming.")]
		[RequiresDynamicCode("Newtonsoft.Json relies on dynamically creating types that may not be available with Ahead of Time compilation.")]
		...
		// Token: 0x060007B5 RID: 1973 RVA: 0x00021A60 File Offset: 0x0001FC60
		...
		// Token: 0x060007B6 RID: 1974 RVA: 0x00021B3C File Offset: 0x0001FD3C
		[RequiresUnreferencedCode("Newtonsoft.Json relies on reflection over types that may be removed when trimming.")]
		[RequiresDynamicCode("Newtonsoft.Json relies on dynamically creating types that may not be available with Ahead of Time compilation.")]
		...
		// Token: 0x060007B7 RID: 1975 RVA: 0x00021D08 File Offset: 0x0001FF08
		[NullableContext(2)]
		[RequiresUnreferencedCode("Newtonsoft.Json relies on reflection over types that may be removed when trimming.")]
		...
		// Token: 0x060007B9 RID: 1977 RVA: 0x00021E84 File Offset: 0x00020084
		[RequiresUnreferencedCode("Newtonsoft.Json relies on reflection over types that may be removed when trimming.")]
		[RequiresDynamicCode("Newtonsoft.Json relies on dynamically creating types that may not be available with Ahead of Time compilation.")]
		...
		// Token: 0x060007BA RID: 1978 RVA: 0x00022074 File Offset: 0x00020274
		[RequiresUnreferencedCode("Newtonsoft.Json relies on reflection over types that may be removed when trimming.")]
		...
		// Token: 0x060007BB RID: 1979 RVA: 0x000221C2 File Offset: 0x000203C2
		...
		// Token: 0x060007BC RID: 1980 RVA: 0x000221EC File Offset: 0x000203EC
		...
		// Token: 0x060007BD RID: 1981 RVA: 0x00022264 File Offset: 0x00020464
