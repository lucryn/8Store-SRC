...
namespace Newtonsoft.Json.Linq.JsonPath
{
	...
	internal class JPath
	{
		...
		// (get) Token: 0x06000BB7 RID: 2999 RVA: 0x0002D9E3 File Offset: 0x0002BBE3
		public List<PathFilter> Filters { get; }

		// Token: 0x06000BB8 RID: 3000 RVA: 0x0002D9EB File Offset: 0x0002BBEB
		...
		// Token: 0x06000BB9 RID: 3001 RVA: 0x0002DA18 File Offset: 0x0002BC18
		private void ParseMain()
		{
			...
			if (!this.ParsePath(this.Filters, currentIndex, false))
			{
				...
				{
					throw new JsonException("Unexpected character while parsing path: " + this._expression.get_Chars(currentIndex2).ToString());
				}
			}
		}

		// Token: 0x06000BBA RID: 3002 RVA: 0x0002DAF4 File Offset: 0x0002BCF4
		...
		// Token: 0x06000BBB RID: 3003 RVA: 0x0002DD6C File Offset: 0x0002BF6C
		...
		// Token: 0x06000BBC RID: 3004 RVA: 0x0002DD80 File Offset: 0x0002BF80
		...
		// Token: 0x06000BBD RID: 3005 RVA: 0x0002DDFC File Offset: 0x0002BFFC
			...
			while (this._currentIndex < this._expression.Length)
			{
				...
				else if (c == indexerCloseChar)
				{
					...
					if (list != null)
					{
						...
						int num4 = Convert.ToInt32(this._expression.Substring(currentIndex, num3), CultureInfo.InvariantCulture);
						list.Add(num4);
					...
					else
					{
						if (num2 > 0)
						{
							if (num3 > 0)
							{
								int num5 = Convert.ToInt32(this._expression.Substring(currentIndex, num3), CultureInfo.InvariantCulture);
								if (num2 == 1)
								{
									end = new int?(num5);
								}
						...
						int num6 = Convert.ToInt32(this._expression.Substring(currentIndex, num3), CultureInfo.InvariantCulture);
				...
				{
					int num7 = (num ?? this._currentIndex) - currentIndex;
					if (num7 == 0)
					{
						throw new JsonException("Array index expected.");
					}
					...
					string text = this._expression.Substring(currentIndex, num7);
				...
				{
					int num8 = (num ?? this._currentIndex) - currentIndex;
					if (num8 > 0)
					{
						int num9 = Convert.ToInt32(this._expression.Substring(currentIndex, num8), CultureInfo.InvariantCulture);
						if (num2 == 0)
						{
							start = new int?(num9);
						}
		...
		// Token: 0x06000BBE RID: 3006 RVA: 0x0002E14B File Offset: 0x0002C34B
		...
		// Token: 0x06000BBF RID: 3007 RVA: 0x0002E188 File Offset: 0x0002C388
		...
		// Token: 0x06000BC0 RID: 3008 RVA: 0x0002E270 File Offset: 0x0002C470
		...
		// Token: 0x06000BC1 RID: 3009 RVA: 0x0002E2F4 File Offset: 0x0002C4F4
		...
		// Token: 0x06000BC2 RID: 3010 RVA: 0x0002E32C File Offset: 0x0002C52C
		...
		// Token: 0x06000BC3 RID: 3011 RVA: 0x0002E384 File Offset: 0x0002C584
		...
		// Token: 0x06000BC4 RID: 3012 RVA: 0x0002E514 File Offset: 0x0002C714
		[NullableContext(2)]
			...
			if (char.IsDigit(c) || c == '-')
			{
				...
				while (this._currentIndex < this._expression.Length)
				{
					...
					if (c == ' ' || c == ')')
					{
						...
						{
							double num;
							bool result = double.TryParse(text, 231, CultureInfo.InvariantCulture, ref num);
							value = num;
							return result;
						}
						long num2;
						bool result2 = long.TryParse(text, 7, CultureInfo.InvariantCulture, ref num2);
						value = num2;
						return result2;
					}
					else
		...
		// Token: 0x06000BC5 RID: 3013 RVA: 0x0002E664 File Offset: 0x0002C864
		...
		// Token: 0x06000BC6 RID: 3014 RVA: 0x0002E7BC File Offset: 0x0002C9BC
		...
		// Token: 0x06000BC7 RID: 3015 RVA: 0x0002E8B4 File Offset: 0x0002CAB4
		private bool Match(string s)
		{
			int num = this._currentIndex;
			for (int i = 0; i < s.Length; i++)
			{
				if (num >= this._expression.Length || this._expression.get_Chars(num) != s.get_Chars(i))
				{
					return false;
				}
				num++;
		...
		// Token: 0x06000BC8 RID: 3016 RVA: 0x0002E90C File Offset: 0x0002CB0C
		...
		// Token: 0x06000BC9 RID: 3017 RVA: 0x0002E9DC File Offset: 0x0002CBDC
		...
		// Token: 0x06000BCA RID: 3018 RVA: 0x0002EAC3 File Offset: 0x0002CCC3
		...
		// Token: 0x06000BCB RID: 3019 RVA: 0x0002EADF File Offset: 0x0002CCDF
		...
		// Token: 0x06000BCC RID: 3020 RVA: 0x0002EAF0 File Offset: 0x0002CCF0
